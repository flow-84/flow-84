...
<p align="center">
  <a href="https://github.com/flow-84">
    <img src="https://readme-typing-svg.demolab.com/?lines=KI-Automation+%26+Autonome+Agenten;Multi-Agent-Systeme+%26+LLM-Orchestrierung;Telegram-Bots+%26+Lead-Automation;Slack+%E2%80%A2+Trello+%E2%80%A2+ClickUp+%E2%80%A2+n8n;Manuelle+Prozesse+%E2%86%92+Produkte&center=true&width=620&height=46&color=ff00e5&background=0A011800&size=22&weight=600&font=Fira+Code&duration=3500&pause=700" alt="Tagline"/>
  </a>
</p>
...
Hi, ich bin **fl0w** 👾 - Builder für **KI-Automation, autonome Multi-Agent-Systeme und Bots** aus Athen.
...
**☁️ Cloud & Plattformen** *(Fundament/Background)*
...
Verbinde, was sonst per Hand läuft: **Slack · Trello · ClickUp · n8n · Make**. Webhooks, Event-Routing und
...
|---|---|---|
| 🧭 [agencyflow](https://github.com/flow-84/agencyflow) | Agentur-Management-Tool — Projekte, Boards & Workflows an einem Ort | `JavaScript` |
| 🛡️ [DSGVO-Agent](https://github.com/flow-84/DSGVO-Agent) | KI-Agent, der DSGVO-Prüfungen, Doku & Audit-Vorbereitung automatisiert | `TypeScript` `AI` |
| 🦾 [open-claw](https://github.com/flow-84/open-claw) | Experimente rund um autonome Agenten & Tooling | `TypeScript` |
